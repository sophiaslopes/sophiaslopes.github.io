...
export const resumeData = {
  ...
  about: "Resolvo problemas e entrego soluções. Durante minha evolução profissional, desenvolvi grandes habilidades que me beneficiaram em minha visão dinâmica e ágil ao entregar resultados. Visando sempre a qualidade e satisfação, busco uma oportunidade onde eu possa aplicar meu diferencial.",
  summary:`- Sou uma profissional obcecada por performance.
